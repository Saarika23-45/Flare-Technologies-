...
function buildGlowVars(glowColor: string, intensity: number) {
  ...
  for (let i = 0; i < opacities.length; i++) {
    ...
    vars[key] = `hsl(${base} / ${Math.min(opacities[i] * intensity, 100)}%)`;
  }
  return vars;
}
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  edgeSensitivity = 30,
  glowColor = '40 80 80',
  backgroundColor = '#060b17cc', // Semi-transparent dark background for better readability
  borderRadius = 16, // Matching the updated layout
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
